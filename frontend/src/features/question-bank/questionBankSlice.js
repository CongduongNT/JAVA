...
export const fetchMyBanks = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(err.response?.data?.message || 'Khong the tai danh sach ngan hang')
    }
  }
)
...
export const createBank = createAsyncThunk(
  ...
  async (data, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(err.response?.data?.message || 'Khong the tao ngan hang')
    }
  }
)
...
export const updateBank = createAsyncThunk(
  ...
  async ({ id, data }, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(err.response?.data?.message || 'Khong the cap nhat ngan hang')
    }
  }
)
...
export const deleteBank = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(err.response?.data?.message || 'Khong the xoa ngan hang')
    }
  }
)
...
const questionBankSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(fetchMyBanks.pending, (state) => {
        state.status = 'loading'
        state.error = null
      })
      .addCase(fetchMyBanks.fulfilled, (state, { payload }) => {
        state.status = 'succeeded'
        state.list = payload
      })
      .addCase(fetchMyBanks.rejected, (state, { payload }) => {
        state.status = 'failed'
        state.error = payload
      })
      ...
      .addCase(createBank.rejected, (state, { payload }) => {
      ...
      .addCase(deleteBank.pending, (state, { meta }) => {
