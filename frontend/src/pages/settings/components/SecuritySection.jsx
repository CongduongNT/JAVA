...
function validate(form) {
  ...
  else if (form.confirmPassword !== form.newPassword) errs.confirmPassword = 'Mật khẩu xác nhận không khớp'
  return errs
}
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Để bảo mật tài khoản, hãy dùng mật khẩu mạnh và không chia sẻ với người khác
        </CardDescription>
      </CardHeader>
