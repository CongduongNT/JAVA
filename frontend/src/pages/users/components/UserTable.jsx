...
const ROLE_LABEL = {
  ADMIN: 'Admin', MANAGER: 'Manager', STAFF: 'Staff', TEACHER: 'Teacher',
}
...
function StatusBadge({ isActive }) {
  return isActive ? (
    ...
    <Badge variant="secondary" className="text-xs">Khoá</Badge>
  )
}
            ...
            {isLoading ? (
              ...
              users?.map((user, idx) => (
                <TableRow key={user.id} className="hover:bg-muted/30 transition-colors">
                  ...
                  <TableCell><RoleBadge role={user.roleName} /></TableCell>
